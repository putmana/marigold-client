...
<div class="sidebar" class:expanded on:mouseenter={expand} on:mouseleave={collapse}>
	<Tab route="/listen/playlists" label="PLAYLISTS" {expanded}>
		<i class="bi bi-music-note-list"></i>
	</Tab>
	<Tab route="/listen/albums" label="ALBUMS" {expanded}>
		<i class="bi bi-vinyl"></i>
	</Tab>
	{#await username}
		<Tab route="/auth/login" label="LOGOUT" {expanded}>
